...
export interface WhatsappWidgetApiAdapter {
  ...
  getTemplates?: (refs: Array<{ reference_doctype: string; reference_name: string }>) => Promise<WhatsAppTemplateResponse[]>;
  sendMessage: (payload: SendWhatsAppMessagePayloadAdapter) => Promise<{ name?: string }>;
